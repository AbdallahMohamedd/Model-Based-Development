...
#ifndef Closed_Loop_types_h_
#define Closed_Loop_types_h_
#include "MW_SVD.h"
#include "rtwtypes.h"
...
typedef struct tag_RWocY1aAVmuibq0rYX5t0G codertarget_arduinobase_int_f_T;

#endif                             /* typedef_codertarget_arduinobase_int_f_T */

/* Parameters (default storage) */
typedef struct P_Closed_Loop_T_ P_Closed_Loop_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_Closed_Loop_T RT_MODEL_Closed_Loop_T;

#endif                                 /* Closed_Loop_types_h_ */

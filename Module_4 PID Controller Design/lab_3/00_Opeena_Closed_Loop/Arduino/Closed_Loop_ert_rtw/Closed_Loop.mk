###########################################################################
## Makefile generated for component 'Closed_Loop'. 
## 
## Makefile     : Closed_Loop.mk
## Generated on : Sun Jun 29 19:53:51 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Closed_Loop.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Closed_Loop.elf
...
DEFINES_STANDARD = -DMODEL=Closed_Loop -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o MW_PWM.o MW_PWMDriver.o xcp_ext_mode.o Closed_Loop.o Closed_Loop_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o platform_timer.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/Closed_Loop_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Closed_Loop_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Closed_Loop_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Closed_Loop.o : $(START_DIR)/Closed_Loop_ert_rtw/Closed_Loop.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Closed_Loop_data.o : $(START_DIR)/Closed_Loop_ert_rtw/Closed_Loop_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Closed_Loop_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
